...
ImGuiStyle::ImGuiStyle()
{
    ...
    WindowRounding          = 12.0f;            // Radius of window corners rounding. Set to 0.0f to have rectangular windows
    ...
    PopupRounding           = 12.0f;            // Radius of popup window corners rounding. Set to 0.0f to have rectangular child windows
    PopupBorderSize         = 1.0f;             // Thickness of border around popup or tooltip windows. Generally set to 0.0f or 1.0f. Other values not well tested.
    FramePadding            = ImVec2(4,3);      // Padding within a framed rectangle (used by most widgets)
    FrameRounding           = 12.0f;            // Radius of frame corners rounding. Set to 0.0f to have rectangular frames (used by most widgets).
    ...
    GrabRounding            = 12.0f;            // Radius of grabs corners rounding. Set to 0.0f to have rectangular slider grabs.
    TabRounding             = 12.0f;            // Radius of upper corners of a tab. Set to 0.0f to have rectangular tabs.
