...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Custom\0Dark\0Custom Dark\0Light\0Green Blue\0"))
    {
        switch (style_idx)
        {
        case 0: ImGui::NovaColor(); break;
        case 1: ImGui::StyleColorsDark(); break;
        case 2: ImGui::StyleColorsCustomDark(); break;
        case 3: ImGui::StyleColorsLight(); break;
        case 4: ImGui::StyleColorsGreen(); break;
        }
        return true;
    }
    return false;
